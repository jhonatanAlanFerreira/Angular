import { Directive, OnInit, Renderer2, ElementRef, Input, HostListener, AfterViewChecked, AfterContentInit, HostBinding } from '@angular/core';
...
export class TestDirective implements OnInit, AfterContentInit {
  ...
  //HostBinding gets the element on which it was declared
  @HostBinding('style.backgroundColor') color:string = 'grey';
